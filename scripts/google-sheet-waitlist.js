/**
 * Shared waitlist receiver for every project.
 * Paste this into Extensions → Apps Script on the spreadsheet that holds all lists.
 * Deploy → New deployment → Web app
 *   Execute as: Me
 *   Who has access: Anyone
 * Then put the web app URL in GOOGLE_SHEETS_WEBHOOK_URL on each app.
 *
 ...
 *
 * Optional: Project Settings → Script properties → NOTIFY_EMAIL
 * (your address, or comma-separated). New rows email you. Duplicates do not.
 */
function doPost(e) {
  try {
