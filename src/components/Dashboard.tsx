        ...
        <div className="min-h-screen bg-background text-foreground flex overflow-hidden font-sans select-none">
            ...
            <main className="flex-1 flex flex-col items-center justify-between p-8 relative overflow-hidden">
                ...
                <div className="z-10 w-full max-w-4xl flex flex-col items-center mt-12">
                    ...
                    {/* Dropzone Area */}
                    <div className={cn(
                        "w-full max-w-3xl bg-card border border-border rounded-2xl aspect-[2.8/1] flex items-center justify-center relative group transition-all duration-300",
                        isDragging ? "border-primary shadow-glow ring-4 ring-primary/5" : "hover:border-primary/30 hover:shadow-md"
                    )}>
                        <PDFUpload
