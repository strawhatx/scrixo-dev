...
export default function SignPDFMobilePage() {
  return (
    <SEOToolPage
      ...
      explainer="Mobile PDF signing should not mean installing a scanner. If you can open this page, you can sign the document and download it. For phone-sized screens see the phone guide; iPad uses the same flow in Safari."
      tool="sign"
      ...
      sections={[
        ...
        },
        {
          ...
          body: "Skip the App Store and Play Store for a one-time signature. Device-specific notes live on the iPhone, Android, and phone pages.",
        },
      ]}
      faqs={[
        {
